...
export function validateIngestionEventInput(input: unknown):
  | { success: true; data: IngestionEventInput }
  ...
  return {
    ...
    data: {
      tenant_id,
      device_id,
      event_type: event_type as IngestionEventInput["event_type"],
      event_value: event_value as IngestionEventInput["event_value"],
      event_time,
    },
  };
}
