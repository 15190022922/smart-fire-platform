...
exports.seedDemoCoreData = seedDemoCoreData;
...
async function seedDemoCoreData(client) {
    ...
    ('account-platform-1', 'platform_admin', '', '${(0, password_1.hashPassword)("Admin123456")}', '平台超级管理员', 'platform', 'platform_super_admin', NULL, false),
    ('account-tenant-hx-1', 'hx_admin', '', '${(0, password_1.hashPassword)("Hx123456")}', '华星制造管理员', 'tenant', 'tenant_level_1', 'tenant-huaxing', true),
    ('account-tenant-ah-1', 'ah_admin', '', '${(0, password_1.hashPassword)("Ah123456")}', '安和商业中心管理员', 'tenant', 'tenant_level_1', 'tenant-anhe', true)
    ON CONFLICT (id) DO NOTHING;
...
async function seedDemoSpatialData(client) {
