...
exports.platformNoticeAttachmentsMigration = void 0;
exports.platformNoticeAttachmentsMigration = {
    id: "0008_platform_notice_attachments",
    description: "Normalize platform notice attachments and inbox state",
    up: async (client) => {
        await client.query(`
